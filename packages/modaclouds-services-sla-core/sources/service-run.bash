...
_variable_defaults=(
		...
		_BIN='@{definitions:environment:BIN}'
		_LIB='@{definitions:environment:LIB}'
		
		_MONITORING_MANAGER_ENDPOINT_IP='@{definitions:environment:MONITORING_MANAGER_ENDPOINT_IP}'
		_MONITORING_MANAGER_ENDPOINT_PORT='@{definitions:environment:MONITORING_MANAGER_ENDPOINT_PORT}'
