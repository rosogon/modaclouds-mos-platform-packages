...
_environment+=(
		# FIXME:  Replace `MODACLOUDS_SERVICE_MRT_` with `MODACLOUDS_MODELS_AT_RUNTIME_`
		MODACLOUDS_SERVICE_MRT_ENDPOINT_IP="${_MRT_ENDPOINT_IP}"
		MODACLOUDS_SERVICE_MRT_ENDPOINT_PORT="${_MRT_ENDPOINT_PORT}"
)
